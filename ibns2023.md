...
* Genome-wide association study and candidate genes
...
Note:
We all know nicotine is higly addictive. However, unlikely other addictive sustances, it does not produce strong euhphorian. Not only that, it also has strong aversive properties. This aversiveness is especially promimant in non-smokers, or in otherwords, for people start experimenting with tobacco. New smokers experience diziness, sickness 
...
Note: 
In rats, the aversive property of nicotine has long been identified using the conditioned tast aversion procedue. for example, in this work published 40 years ago, 
rats first consume flavored solution, they then receive injections of saline or nicotine.
The observation is that rats avoid to consume the taste where they experience the effect of nicotine. 
The interpertation is that the experience of nicotine is aversive.
...
https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2044849/?page=3
Flavors: sodium sacchaine vs sodium chloride
Water access were limited to 1 h per day. 
Tastes were presented every other day, followed by nicotine vs saline injection. 
...
In this study, we implated jugular catheters into adulescent sprague dawley rats. These rats are placed in operant chambers. 
<b>FR10TO20</b>
Session length is 3h

We added a yoked group to demonstrate that the reduced lick is not because nicotine has a general effect on inhibiting lick behavior, rather, it is because the contingent pairing of nicoine and the flavor that is paired with nicotine.
...
There is a large literaure on this paradigm. It has been figured out that social learning requries two signals, one is the odor of the food, and the other signal is a a component of breath called carbon disulfide. So the effect of demonstrator rat can be replaced by using a cotton swap contains a novel odor and cabon disulfide.  
...
Note:
We then incorported social learning into our protocol.

So, the presence of a "demonstrator" rat consuming the same flavor cue, reversed the overall subjective effect of nicotine and suppored  i.v. self-administration.
...
The next question is that are rats self-administering nicotine or the flavor cue?  To demonstrate that the appetitiveness of flavor cue is not driving nicotine intake in our model, we replaced the sacchrine cue with a quinine cue, which is bitter. 
We also improved our control by adding a demonstration rat on the left side of the operant chamber, so now we have a control enviroment that is social but does not support social learning. 
Top three panels demonstrate Q is aversive and does not support nicotine IVSA. panel d in bottom middle shows rats will self-administer nicotine after social learning. The difference between top and bottom is the prsence of flacor cue avaible to the demonstrator rats

these data estabilished that the primary driver for licking in this model is nicotine and not the flavor cue.
...
Note:
in fact, when we over lap the behavior data from those rats self-administering nicotine with appeteive vs aversive cues, the amount of nicotine they obtained are almost identical. 
...
<li >  This model incoporates the aversive and reinforcing properties of nicotine  </li>
<li class="fragment">  Operant responding is driven by the rewarding property of nicotine 
<ul>
	<li class="fragment"> rats maintain similar number of nicotine infusions when tested using appetitive or aversive flavor cues 
	<li class="fragment"> rats change the number of licks when differnt concentration of nicotine were given to maintain stable nicotine intake
    </ul>
<li class="fragment"> Social learning facilitates nicotine intake by enhancing the extinction of conditioned aversion
<li class="fragment"> Social learning for nicotine is mediated by Carbon Disulfide in the breath 
<li class="fragment"> Social learning requires oxytocin signalling 

Note:
It models the complex sensory and social cues for smoking.
can we used for genetic studies?
...
Note:
to study the gentics, we need to first establish that this is behavior is heritable. So far we used outbred SD rats. 

Inbred strains can be used for gentics studes. We are using panels of inbred strains to study nicotine and opioids in the lab but for this study, we used outbred rats.
...
---
## Genetic diversity in the HS founders

<img src="images/Figure7_HS_progenitors_redone.png" width=50%>

<span id="cite"> de Jong et al, BioRxiv, 2023</span>

Note:

Tristan de jong in my lab recently anayzed WGS of 160 inbred rats and found close to 20M varinants. about 80 of these variants are present in the eight HS founders.  
...
## Behavior test protocol for GWAS 
<div id="left50">
<font size=3>
...
<img src="images/pde4b_nicotine.png">
</td></tr>
</table>
